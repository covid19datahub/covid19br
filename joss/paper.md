...
The dataset is provided in a tidy data format [@wickham2014tidy], where each row represents an administered COVID-19 dose. There are more than 250 million records and 34 variables (columns) associated with each record, including information about the patient, the municipality of residence, the vaccination center, and the type of dose administered. The data are provided as a Character Separated Value (CSV) file, with a size over 130GB that makes it hardly accessible.
...
This work joins the global ongoing efforts around the topic of COVID-19 data collection [@mathieu2021global; @hasell2020cross; @dong2020interactive; @guidotti2020covid; @hale2020oxford; @wang2020cord].
...
To download large amount of data at speed, one option is to rely on GitHub-hosted cloud runners. GitHub offers Linux runners with the following hardware resources:^[https://docs.github.com/en/actions/using-github-hosted-runners/about-github-hosted-runners]
